...
import 'package:careclock/presentation/widgets/Buttons/confirm_button.dart';
...
class FamilyItemConfirm extends StatelessWidget {
  final double? marginX;
  const FamilyItemConfirm({super.key, this.marginX});
    ...
    return CustomContainer(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          ConfirmButton(width: 100.w, onPress: () {}),
